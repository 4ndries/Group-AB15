...
def Same_track_color_plot(List_of_combined_trackIDs):
    ...
    for i in range(len(trackID)):                     #trackID cheaking
        if trackID[i] in Whitelist_IDs:
            for group in List_of_combined_trackIDs:     #Group of comined trackID
                base = -2
                for ID in group:                         #Parts of the group of trackIDs
                    if base == -2:
                        base = ID
                    if ID == trackID[i]:
                        trackID[i] = base
            ...
            trackID[i] = -1
            C = C + 1    
    print (round((100-((C/(end-start))*100)),2),"% of data retained(",round(((C/(end-start))*100),2),"% of data taken out)")
    ...
    #Lable the start of the track ID
